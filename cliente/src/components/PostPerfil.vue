          ...
          <!-- <div class="col s2"></div> -->
            ...
            <div class="card white darken-1">
              <div class="card-content white-text">
                ...
                :perfil="conteudo.user.image" :data="conteudo.data"/></span>
...
export default {
  ...
  methods: {
    curtida(id){
      ...
      this.$http.put(`${this.$urlAPI}conteudo/curtidaperfil/${id}`,{}, {"headers": {"authorization":"Bearer " + this.getToken}})
        .then(res => {
    ...
    comentar(id){
      ...
      this.$http.post(`${this.$urlAPI}conteudo/comentariopagina/${id}`, {
